const apikey="ec099ae50e33a93bfc6690f8f4524bf1";
// const apikey="60a54661f42e44379f8170125231310";
...
window.addEventListener("load",()=>{
    if(navigator.geolocation){
        navigator.geolocation.getCurrentPosition((position)=>{
            ...
            //const url=`api.openweathermap.org/data/2.5/forecast/daily?lat={lat}&lon={lon}&cnt={cnt}&appid={apikey}`
...
function hourForecast(forecast){
    ...
    for (let i = 0; i < 5; i++) {
        ...
        temp.innerText= Math.floor((forecast.list[i].main.temp_max - 273))+ ' °C' + ' / ' + Math.floor(((forecast.list[i].main.temp_min - 273)*9/5 +32))+ ' °F';
